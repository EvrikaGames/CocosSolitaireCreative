      ...
      _export("QuizController", QuizController = (_dec = ccclass('QuizController'), _dec2 = property({
        ...
        buildQuiz(config) {
          ...
          for (let i = 0; i < quizSplits.length; i++) {
            const data = new (_crd && QuizData === void 0 ? (_reportPossibleCrUseOfQuizData({
              error: Error()
            }), QuizData) : QuizData)();
        ...
        applyData() {
          const data = this.getCurrentQuizData();
...
//# sourceMappingURL=429b9fba0cd0be3f9c560b2988d50ccfdeeeb88d.js.map