    ...
    execute: function () {
      ...
      _export("HintController", HintController = (_dec = ccclass('HintController'), _dec2 = property({
        ...
        tryOpenRandomLetters(count) {
          var result = false;
          var closedCells = this.crosswordController.crossword.cells.filter(cell => !cell.opened);

          for (var i = 0; i < count; i++) {
            if (closedCells.length === 0) break;
            var index = Math.floor(Math.random() * closedCells.length);
...
//# sourceMappingURL=ea34c7553c8edd67f88050d05ec16c20b75fac41.js.map