  ...
  return {
    ...
    execute: function () {
      ...
      _export("default", GameController = (_dec = property(Node), _dec2 = property(Label), _dec3 = property(Prefab), _dec4 = property(Node), _dec5 = property(Prefab), _dec6 = property(Node), _dec7 = property(Prefab), _dec8 = property(Node), _dec9 = property(Node), _dec10 = property(Node), _dec11 = property({
        ...
        start() {
          var blockerComponent = this.blocker.getComponent(_crd && Blocker === void 0 ? (_reportPossibleCrUseOfBlocker({
            error: Error()
          }), Blocker) : Blocker);
          ...
          var loadSentences = new Promise((resolve, reject) => {
          ...
          var loadLetters = new Promise((resolve, reject) => {
          ...
          var loadCards = new Promise((resolve, reject) => {
        ...
        buildSentences(config) {
          this.predefinedSentences = [];
          var centencesSplits = config.split('\n');

          for (var i = 0; i < centencesSplits.length; i++) {
        ...
        buildWords(config) {
          this.predefinedWordStrings = [];
          var wordsSplits = config.split('\n');

          for (var i = 0; i < wordsSplits.length; i++) {
        ...
        createCompletedWords() {
          for (var j = 0; j < this.predefinedWords.length; j++) {
            ...
            completedWordNode.getComponent(_crd && Word === void 0 ? (_reportPossibleCrUseOfWord({
              error: Error()
            }), Word) : Word).setNumber(j + 1);
        ...
        moveCardToWord(card) {
          if (card.isSelected == false) {
            ...
            for (var i = this.currentLetterIndex - 1; i >= 0; i--) {
              var currentCard = this.letterSlots[i].getCard();
        ...
        getCorrectVariant() {
          ...
          for (var _i = 0; _i < mass.length; _i++) {
            if (mass[_i].label.string == this.letterSlots[this.currentLetterIndex].letter) {
              return mass[_i];
            }
          }
...
//# sourceMappingURL=eb9aec31b330f42ea4099cb191f8ddf22f2550e8.js.map