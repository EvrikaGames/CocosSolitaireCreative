    ...
    execute: function () {
      ...
      _export("TutorialHandMover", TutorialHandMover = (_dec = ccclass('TutorialHandMover'), _dec2 = property({
        ...
        moveHand() {
          ...
          var moveDelay = 0.5;
          var scaleToNormal = 0.3;
          var variants = this.quiz.getActiveVariants();
          var variantIndex = 0;
          this.to = variants[variantIndex].node;
          this.hand.setWorldPosition(this.firstTarget.getWorldPosition());
          var callMoveTween = tween(this.node).call(() => {
          ...
          var delayTween = tween(this.node).delay(moveDelay + scaleToNormal);
          var changeTo = tween(this.node).call(() => {
...
//# sourceMappingURL=74772b9a7e871e3510be7625d4827943b81fc24e.js.map