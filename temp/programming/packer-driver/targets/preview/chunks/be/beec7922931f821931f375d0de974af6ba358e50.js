    ...
    execute: function () {
      ...
      _export("CrosswordController", CrosswordController = (_dec = ccclass('CrosswordController'), _dec2 = property({
        ...
        buildCrossword(config) {
          ...
          var spacingRatio = 0.05;
          var cellSize = (1 - spacingRatio) * transform.width / this.crossword.getMaxSize();
          ...
          var cellSpaceSize = (1 + spacingRatio) * cellSize;
          var offsetX = -cellSpaceSize * this.crossword.sizeX / 2 + cellSpaceSize / 2;
          var offsetY = cellSpaceSize * this.crossword.sizeY / 2 - cellSpaceSize / 2;
        ...
        openWord(word) {
          var crosswordWord = this.crossword.words.find(cw => cw.word === word);
          var opened = false;
          ...
          for (var i = 0; i < crosswordWord.letterCells.length; i++) {
...
//# sourceMappingURL=beec7922931f821931f375d0de974af6ba358e50.js.map